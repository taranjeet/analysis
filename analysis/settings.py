...
SECRET_KEY = '@#1$crs&ssl)s4(_^d0z63jzeoa8i#_9@d00s*@qi!-0co!7&*'
...
TEMPLATE_DIRS = [(os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(__file__))), 'analysistemplates'))]
